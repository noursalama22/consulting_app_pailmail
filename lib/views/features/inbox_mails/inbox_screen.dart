...
class _InboxScreenState extends State<InboxScreen>
  ...
  clear() {
    ...
    Provider.of<CategoriesProvider>(context, listen: false)
        .getSender(selectedIndex: -1, categoryIndex: 0);
    Provider.of<CategoriesProvider>(context, listen: false)
  ...
  Future<void> storeImage(int? id) async {
    for (int i = 0; i < pickedMultiImage.length; i++) {
      print("uuuuuuuuuuuuuuuuuuuuuuu $id");
      await UploadImage().uploadImage(File(pickedMultiImage[i]!.path), id);
    }
  }
    ...
    return SizedBox(
        ...
        child: Padding(
          padding: EdgeInsets.only(
              left: 20.0.w, right: 20.0.w, top: 24.h, bottom: 16.h),
          child: Form(
            key: _formKey,
                                ...
                                Future.delayed(
                                  ...
                                  () async {
                                    ...
                                    await MailsRepository()
                                        ...
                                        .then((value) async {
                                      mail_id = value?.id;
                                      print("oooooooooooooooooooo $mail_id");

                                      showSnackBar(context,
                                          message: "Created Mail", duration: 2);
                                      clear();

                                      await storeImage(mail_id);
                                    }).catchError((err) {
                                      showSnackBar(context,
                        ...
                        : CustomContainer(
                            ...
                            children: [
                              ...
                              CustomTextField(
                                  ...
                                  withoutPrefix: false,
                                  withoutSuffix: false,
                                  hintText: Provider.of<CategoriesProvider>(
                                                  context)
                                              .senderPosition ==
                                          -1
                                      ? "sender name"
                        ...
                        : CustomContainer(
                            ...
                            children: [
                              CustomTextField(
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return 'Please enter the title of mail';
                                  }
                                  ;
                                },
